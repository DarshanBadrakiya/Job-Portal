            ...
            <div className="min-h-screen max-w-7xl mx-auto my-10">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <Button onClick={()=>{navigate("/jobs")}} className="mt-1 outline-none bg-white text-black hover:bg-white" ><ArrowLeft/></Button>
                        <h1 className="font-bold text-xl">{singleJob?.title}</h1>
                        </div>
                        <div className="flex items-center gap-2 mt-4">
                            <Badge className="text-blue-700 font-bold" variant="ghost">{singleJob?.position} Positons</Badge>
                ...
                <div className="my-5 flex flex-col gap-3">
                    ...
                    <h1 className="font-bold text-lg my-1">Total Application : <span className="pl-4 font-normal text-gray-800">{singleJob?.applications?.length}</span></h1>
