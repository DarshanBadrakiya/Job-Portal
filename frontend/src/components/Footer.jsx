...
const Footer = () => {
    return (
        <footer className="border-t border-gray-200 py-8 bg-gradient-to-r from-gray-50 to-gray-100">
  <div className="container mx-auto px-6 md:px-12">
    <div className="flex flex-col md:flex-row justify-between items-center">
      {/* Logo and Info */}
      <div className="text-center md:text-left mb-6 md:mb-0">
        <h2 className="text-2xl font-extrabold text-gray-800">Job Hunt</h2>
